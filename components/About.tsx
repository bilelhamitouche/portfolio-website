export default function About() {
  return (
    <section className="container py-12 px-4 mx-auto space-y-12 max-w-2xl text-center sm:py-16 lg:py-20">
      <h2 className="text-3xl font-bold">About Me</h2>
      <p className="text-lg text-gray-500">
        T&apos;m a passionate fullstack developer specializing in JavaScript
